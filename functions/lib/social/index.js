...
exports.removeFamilyMember = exports.declineFamilyRequest = exports.acceptFamilyRequest = exports.addOrRequestFamilyMember = exports.unsendFriendRequest = exports.removeFriend = exports.declineFriendRequest = exports.acceptFriendRequest = exports.sendFriendRequest = exports.testAuthentication = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
// Simple test function to debug authentication issues
exports.testAuthentication = functions.https.onCall(async (data, context) => {
...
exports.addOrRequestFamilyMember = functions.https.onCall(async (data, context) => {
    var _a;
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        if (linkedUserModel) {
            ...
            batch.set(familyRequestRef, {
                ...
                requesterName: (_a = (await db.collection('endUsers').doc(currentUserId).get()).data()) === null || _a === void 0 ? void 0 : _a.name,
        ...
        batch.set(familyMemberRef, {
            ...memberData,
            linkedUserId: linkedUserModel === null || linkedUserModel === void 0 ? void 0 : linkedUserModel.uid,
...
exports.acceptFamilyRequest = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.declineFamilyRequest = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const { requesterUserId } = data;
