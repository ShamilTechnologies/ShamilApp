/// File: lib/feature/auth/data/service_provider_model.dart
...
import 'package:shamil_mobile_app/core/utils/email_validate.dart';
import 'package:shamil_mobile_app/feature/auth/data/bookable_service.dart';
...
/// Represents an access pass option for access-based reservations.
...
/// Represents the main data model for a Service Provider user.
class ServiceProviderModel extends Equatable {
  ...
  final List<String>
      supportedReservationTypes; // List of ReservationType enum names
  ...
  factory ServiceProviderModel.fromFirestore(DocumentSnapshot doc) {
    ...
    final List<String> galleryUrls =
        List<String>.from(data['galleryImageUrls'] as List? ?? []);
    final List<String>? staffUidsList = data['staffUids'] == null
        ? null
    ...
    // Parse supportedReservationTypes (expecting List<String>)
    final List<String> supportedTypes =
        List<String>.from(data['supportedReservationTypes'] as List? ?? []);

    // Parse reservationTypeConfigs (expecting Map<String, dynamic>)
    final Map<String, dynamic> typeConfigs =
        Map<String, dynamic>.from(data['reservationTypeConfigs'] as Map? ?? {});

    // Parse maxGroupSize
    final int? maxGroupSizeValue = (data['maxGroupSize'] as num?)?.toInt();

    // Parse accessOptions using the new class
    ...
    return ServiceProviderModel(
      ...
      // Pricing & Reservations
      pricingModel: pricing, subscriptionPlans: subscriptionPlansList,
  ...
  /// Converts to Map for Firestore storage with explicit null values
  Map<String, dynamic> toMap() {
    final mapData = {
      // --- Core & Personal ---
      'ownerUid': ownerUid,
      ...
      'idNumber': idNumber,
      'dob':
          dob == null ? null : Timestamp.fromDate(dob!), // Explicitly send null
      ...
      'businessSubCategory':
          businessSubCategory, // Explicitly send null if null
  ...
  /// Creates a copy with updated fields and support for explicit null setting
  ServiceProviderModel copyWith({
    ...
    int? maxGroupSize,
    List<AccessPassOption>? accessOptions,
    String? seatMapUrl,
    String? logoUrl,
    String? mainImageUrl,
    ...
    // --- Force Null Flags ---
    bool forceDobNull = false,
    bool forceGenderNull = false,
    bool forceIdFrontNull = false,
    bool forceIdBackNull = false,
    bool forceProfilePicNull = false,
    bool forceSubCategoryNull = false,
    bool forceLocationNull = false,
    bool forceGovernorateIdNull = false,
    bool forceOpeningHoursNull = false,
    bool forceMaxGroupSizeNull = false,
    bool forceAccessOptionsNull = false,
    bool forceSeatMapUrlNull = false,
    bool forceLogoNull = false,
    bool forceMainImageNull = false,
    bool forceStaffNull = false,
    bool forceUpdatedAtNull = false,
  }) {
    ...
    return ServiceProviderModel(
      ...
      idFrontImageUrl:
          forceIdFrontNull ? null : (idFrontImageUrl ?? this.idFrontImageUrl),
      idBackImageUrl:
          forceIdBackNull ? null : (idBackImageUrl ?? this.idBackImageUrl),
      profilePictureUrl: forceProfilePicNull
          ? null
      ...
      businessSubCategory: forceSubCategoryNull
          ? null
      ...
      location: forceLocationNull ? null : (location ?? this.location),
      governorateId:
          forceGovernorateIdNull ? null : (governorateId ?? this.governorateId),
      // Operations
      openingHours:
          forceOpeningHoursNull ? null : (openingHours ?? this.openingHours),
      ...
      maxGroupSize:
          forceMaxGroupSizeNull ? null : (maxGroupSize ?? this.maxGroupSize),
      accessOptions:
          forceAccessOptionsNull ? null : (accessOptions ?? this.accessOptions),
      seatMapUrl: forceSeatMapUrlNull ? null : (seatMapUrl ?? this.seatMapUrl),
      // Assets
      logoUrl: forceLogoNull ? null : (logoUrl ?? this.logoUrl),
      mainImageUrl:
          forceMainImageNull ? null : (mainImageUrl ?? this.mainImageUrl),
  ...
  bool isBusinessDataValid() {
    bool addressValid = address['street'] != null &&
  ...
  bool isPricingValid() {
    ...
    switch (pricingModel) {
      ...
      case PricingModel.reservation:
        ...
        return supportedReservationTypes.isNotEmpty &&
            _hasValidConfigForSupportedTypes();
  ...
  bool _hasValidConfigForSupportedTypes() {
    ...
    if (supportedReservationTypes.any((t) => [
              'timeBased',
              'recurring',
              'group',
              'seatBased',
    ...
    if (!hasAnyConfig &&
        supportedReservationTypes.contains('accessBased') &&
        (accessOptions?.isNotEmpty ?? false)) {
      hasAnyConfig = true;
    }
    return hasAnyConfig;
  }
