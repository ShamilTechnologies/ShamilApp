...
class _CategoryDetailScreenState extends State<CategoryDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        ...
        context
            .read<HomeBloc>()
            .add(FilterByCategory(category: widget.categoryName));
  ...
  void _onSubCategorySelected(String subCategory) {
    ...
    context.read<HomeBloc>().add(FilterBySubCategory(
        mainCategory: widget.categoryName, subCategory: subCategory));
  }
              ...
              builder: (context, state) {
                ...
                if (state is HomeDataLoaded) {
                  ...
                  if (loadedState.filteredByCategory == widget.categoryName &&
                      (loadedState.selectedSubCategory ?? "All") ==
                          (_selectedSubCategory ?? "All")) {
                    ...
                    print(
                        "State filters (${loadedState.filteredByCategory}/${loadedState.selectedSubCategory}) don't match UI (${widget.categoryName}/$_selectedSubCategory). Showing potentially empty list.");
                  }
                ...
                if (isLoading && providers.isEmpty) {
                  return GridView.builder(
                    ...
                    itemBuilder: (ctx, index) =>
                        const ServiceProviderCardShimmer(),
                  );
                }
                  ...
                  return Center(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Gap(16),
                        Text(
                          "No providers found for '${_selectedSubCategory ?? widget.categoryName}'.",
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ServiceProviderCard(
                      ...
                      onTap: ServiceProviderNavigation
                          .createProviderCardNavigation(
                        context,
                        provider: provider,
                        heroTagPrefix: "category_${widget.categoryName}",
                      ),
