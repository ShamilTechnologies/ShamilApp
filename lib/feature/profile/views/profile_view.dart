...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _handleLogout() async {
    ...
    // 2. If confirmed, dispatch the event (DO NOT NAVIGATE HERE)
    if (confirm == true && mounted) {
      ...
      try {
        ...
        // *** REMOVED Navigation: The global listener in main.dart will handle navigation ***
            ...
            builder: (context, authState) {
              ...
              if (authState is LoginSuccessState) {
                ...
                return ProfileContent(
                  userModel: userModel,
                  isUpdatingPicture:
                      _isUpdatingPicture, // Pass loading flag down
                  onUpdatePicture:
