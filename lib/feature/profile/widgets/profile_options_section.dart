...
class ProfileOptionsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
         _buildProfileOption(context, Icons.person_outline_rounded, 'Edit Profile', () {
             print("Navigate to Edit Profile");
             // TODO: Navigator.push(context, MaterialPageRoute(builder: (_) => EditProfileView()));
          }),
          _buildProfileOption(context, Icons.people_alt_outlined, 'Friends', () {
             ...
             try {
                Navigator.push(context, MaterialPageRoute(builder: (_) =>
                   BlocProvider.value(
                      value: context.read<SocialBloc>(), // Read Bloc from context
                      child: const FriendsView(),
                   )
                ));
             } catch(e) {
                print("Error navigating to FriendsView (SocialBloc not found?): $e");
             }
          }),
          ...
          _buildProfileOption(context, Icons.help_outline_rounded, 'Help & Support', () {
